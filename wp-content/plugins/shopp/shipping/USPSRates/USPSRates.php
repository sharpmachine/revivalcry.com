 ...
 *
 * $Id: USPSRates.php 8 2011-04-15 00:13:25Z jdillick $
 **/
...
class USPSRates extends ShippingFramework implements ShippingModule {
	...
	function calculate ($options,$Order) {
		...
		if (!$Response) {
			new ShoppError(__('Shipping options and rates are not available from UPS. Please try again.','Shopp'),'usps_rate_error',SHOPP_TRXN_ERR);
			return false;
		}
